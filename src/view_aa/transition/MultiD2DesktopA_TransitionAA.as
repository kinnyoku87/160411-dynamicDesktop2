package view_aa.transition
{
	...
	public class MultiD2DesktopA_TransitionAA extends TransitionAA
	{
		
		public var stateA:MultiD_StateAA;
		public var stateB:DesktopA_StateAA;
		...
		override public function onTransfer():void {
			...
			this.stateA = this.getA() as MultiD_StateAA;
			this.stateB = this.getB() as DesktopA_StateAA;
